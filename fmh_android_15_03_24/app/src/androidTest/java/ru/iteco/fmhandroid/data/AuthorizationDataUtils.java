...
public class AuthorizationDataUtils {
    ...
    public static void logIn() {
        ...
        loginPage.typeLogin(AuthorizationData.LoginType);
        loginPage.typePassword(AuthorizationData.PasswordType);
    ...
    public static void goToMainPage() {
        ...
        try {
            ...
            if (navigationPage.checkIfToastButtonVisible()) {
                navigationPage.goToMainPage();
            } else {
                logIn();
            }
        }
